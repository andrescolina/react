...
<div>
    ...
    <section className="landingFirstImg">   
            
        <div className="boxPartOne">
            <div className="leftSidePartOne">

                <VideoOnePC />
               
                </div>
                <div className="rhtSiigdePartOne">
                    <div className="upperSidePartOne">
                        <h1 className="rightAlign tittle"> LA MEJOR PLATAFORMA <br></br> DE EVENTOS</h1>
                    </div><br></br>

                    <div className="middleSidePartOne">
                        <p className="rightAlign3 contents11"> 
                        Crea tu evento virtual mediante nuestra gran plataforma
                        de una manera fácil, sencilla y rápida; en Gran Foro 
                        necesitarás solo de 5 minutos para crear tu evento online,
                        además tendrás estadísticas de audiencia en tiempo real,
                        personalización de diseño e imágenes, transmisión directa 
                        en tus redes sociales, tú sitio web y mucho más 
                        ¿Qué estás esperando para que tus clientes y 
                        audiencia vivan la mejor experiencia digital?
                        </p>
                    </div><br></br>

                    <Link  to="/miEvento"  className="link" >
                        <div className="lowerSidePartOne3">
                            <span className="redButton">PLANES</span>
                        </div>
                    </Link>
